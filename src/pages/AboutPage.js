      ...
      <main className="main-content">
        <section className="section">
          <div className="content">
            ...
            <p>
              Each year, teams of 1-5 work together to create a business climate pitch. Whether that looks like proposing next-gen green technologies, policy-driven initiatives, or community-driven programs, participants innovate and drive forward what's possible. While physical products are encouraged, projects can take the form of digital platforms/software, advocacy campaigns, or community service organizing—all with the goal of tackling today's climate crisis.
            </p>
            <p>
